...
#     def __init__(self, image_shape, dataset_directory):
#         # dataset_directory = './Hela_JPEG_128' #link to data directory
#
#         dataset = self._read_data_sets(dataset_directory)
...
#         self.image_dim = image_shape[0]* image_shape[1] #provide image size
#         self.image_shape = image_shape # provide width, height, channel
#
...
#         img = scipy_misc.imread(path)
#         if len(img.shape) == 0:
#             raise ValueError(path + " got loaded as a dimensionless array!")
#         return img.astype(np.uint8)
#
#     def _read_data_sets(self, dataset_directory):
#         file_pattern = dataset_directory + "/*/*.jpg" # find jpeg only
#         dir_pattern = dataset_directory + "/*"
#
...
#             image_data = self._imread(f)
#             images.append(np.array(image_data))
#             labels.append(label)
#         images = np.array(images)
#         labels = np.array(labels)
#         print ('image size: ', images.shape, 'label size: ', labels.shape)
#
#         test_images = images[:TEST_SIZE]
#         test_labels = labels[:TEST_SIZE]
#
#         train_images = images[TEST_SIZE:]
#         train_labels = images[TEST_SIZE:]
#
